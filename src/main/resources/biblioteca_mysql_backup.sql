/*
MySQL - 5.7.19 : Database - biblioteca
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`biblioteca` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_spanish_ci */;
...
CREATE TABLE `tb_autor` (
  ...
  `nom_autor` varchar(100) CHARACTER SET latin1 NOT NULL,
  `apa_autor` varchar(100) CHARACTER SET latin1 NOT NULL,
  `ama_autor` varchar(100) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE `tb_categoria` (
  ...
  `nom_categoria` varchar(150) CHARACTER SET latin1 NOT NULL,
  PRIMARY KEY (`cod_categoria`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;

/*Data for the table `tb_categoria` */

insert  into `tb_categoria`(`cod_categoria`,`nom_categoria`) values (1,'DRAMA'),(3,'CIENCIA FICCION'),(6,'HORROR');
...
CREATE TABLE `tb_editorial` (
  ...
  `nom_editorial` varchar(100) CHARACTER SET latin1 NOT NULL,
  `dir_editorial` varchar(100) CHARACTER SET latin1 NOT NULL,
  `cod_pais` int(11) NOT NULL,
  PRIMARY KEY (`cod_editorial`),
  KEY `cod_pais` (`cod_pais`),
  CONSTRAINT `tb_editorial_ibfk_1` FOREIGN KEY (`cod_pais`) REFERENCES `tb_pais` (`cod_pais`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;

/*Data for the table `tb_editorial` */
...
CREATE TABLE `tb_libro` (
  ...
  `cod_libro` char(6) CHARACTER SET latin1 NOT NULL,
  `nom_libro` varchar(100) CHARACTER SET latin1 NOT NULL,
  `des_libro` varchar(250) CHARACTER SET latin1 DEFAULT NULL,
  `anio_libro` char(4) CHARACTER SET latin1 DEFAULT NULL,
  `isbn_libro` char(13) CHARACTER SET latin1 DEFAULT NULL,
  `cod_pais` int(11) NOT NULL,
  `cod_autor` int(11) NOT NULL,
  `cod_editorial` int(11) NOT NULL,
  PRIMARY KEY (`id_libro`),
  KEY `fk_libro_pais` (`cod_pais`),
  KEY `fk_libro_autor` (`cod_autor`),
  KEY `fk_libro_editorial` (`cod_editorial`),
  CONSTRAINT `fk_libro_autor` FOREIGN KEY (`cod_autor`) REFERENCES `tb_autor` (`cod_autor`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_libro_editorial` FOREIGN KEY (`cod_editorial`) REFERENCES `tb_editorial` (`cod_editorial`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_libro_pais` FOREIGN KEY (`cod_pais`) REFERENCES `tb_pais` (`cod_pais`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;

/*Data for the table `tb_libro` */
